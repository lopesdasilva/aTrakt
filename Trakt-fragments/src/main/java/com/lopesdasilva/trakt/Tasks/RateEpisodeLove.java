 ...
 */
public class RateEpisodeLove extends AsyncTask<Void, Void, RatingResponse> {
    ...
    public RateEpisodeLove(FragmentActivity activity, OnMarkEpisodeLoveCompleted listener, ServiceManager manager, TvShow show, TvShowEpisode episode, int position){
            ...
            builder.setMessage("Error rating the episode")
                    .setPositiveButton("Retry", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                                new RateEpisodeLove(activity,listener,manager,show_info,episode_info,position).execute();
                        }
                    })
