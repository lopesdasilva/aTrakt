 ...
 */
public class MarkEpisodeNone extends AsyncTask<Void, Void, RatingResponse> {
    ...
    public MarkEpisodeNone(FragmentActivity activity, OnMarkEpisodeNoneCompleted listener, ServiceManager manager, TvShow show, TvShowEpisode episode, int position){
            ...
            builder.setMessage("Error unrating episode")
                    .setPositiveButton("Retry", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                                new MarkEpisodeNone(activity,listener,manager,show_info,episode_info,position).execute();
                        }
                    })
